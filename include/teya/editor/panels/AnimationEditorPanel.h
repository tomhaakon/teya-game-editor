...
private:
 ...
 bool socketDragActive_=false,socketDragChanged_=false; std::size_t socketDragClip_=0,socketDragFrame_=0,socketDragIndex_=0; Vector2 socketDragOffset_{}; teya::animation::AnimationAsset socketDragBefore_;
 bool markerDragActive_=false,markerDragChanged_=false; std::size_t markerDragClip_=0,markerDragFrame_=0,markerDragIndex_=0; Vector2 markerDragOffset_{}; teya::animation::AnimationAsset markerDragBefore_;
 bool hitboxDragActive_=false,hitboxDragChanged_=false; std::size_t hitboxDragClip_=0,hitboxDragFrame_=0,hitboxDragIndex_=0; Vector2 hitboxDragOffset_{}; teya::animation::AnimationAsset hitboxDragBefore_;
};
}
